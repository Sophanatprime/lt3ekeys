...
\begin{itemize}
  ...
  \item \texttt{v} 参数类型，对于 \veta{document-cmd}，其实参的类别码为 10、12、13 之一，而 \veta{ekeys-cmd} 其实参中字符的类别码均为 12（在 \pupTeX 引擎下，仅 Unicode 编码小于等于 255 的字符有此特性）；
...
（不能是 tokenized）。它的实参是一些类别码为 12 的字符
