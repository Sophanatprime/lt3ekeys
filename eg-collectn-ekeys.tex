...
\ifdefined\directlua
  ...
  % 让导入的 pdf 有正确的超链接。编译很慢！！仅限于 luatex
  \IfPDFManagementActiveTF
  {\cus@getgraphicsname\@curr@file{cus-cn.pdf}
    \ifx\@curr@file\relax\else
      \filename@parse\@curr@file
      \edef\@curr@file{\filename@area\filename@base}
      \directlua{
        require("newpax")
        newpax.writenewpax("\@curr@file")
      }
    \fi
    \usepackage{newpax}
